...
% Edited by Levi Boyles
% DENDROGRAM_INFSITES(Z,U) plots the dendrogram for (M-1)-by-3(or4) matrix
% and overlays it with the mutation events in the (2M-1)-by-1 vector of counts U
